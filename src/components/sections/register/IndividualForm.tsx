        ...
        <>
            ...
            <form className="grid grid-cols-2 gap-4">
                <input
                    type="tel"
                    placeholder="Phone*"
                    className="p-3 rounded bg-white border-8 border-white text-black"
                    required
                />
                <input
                    type="text"
                ...
                <input
                    ...
                    required
                />
                <select className="p-3 rounded bg-white border-8 border-white text-black">
                ...
                <input
                    ...
                    className="p-3 rounded bg-white border-8 border-white col-span-2 text-black"
                    required
                />
                <select className="p-3 rounded bg-white border-8 border-white col-span-2 text-black">
                ...
                <div className="col-span-2">
                    ...
                    <input
                        type="file"
                        className="p-3 rounded bg-white border-8 border-white w-full text-black"
                        accept=".pdf,.doc,.docx"
                    />
                </div>
                <input
